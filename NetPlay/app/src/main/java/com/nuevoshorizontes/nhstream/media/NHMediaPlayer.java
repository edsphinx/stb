 ...
 * {@link NHMediaPlayer#getState()} accessor. Most of the frequently used methods are available, but some still
 * need adding.
 * </p>
 */
public class NHMediaPlayer {

    private static String tag = "MediaPlayerWrapper";
    private MediaPlayer mPlayer;
    private State currentState;
    private NHMediaPlayer mWrapper;

    public NHMediaPlayer() {
        mWrapper = this;
