 ...
 *
 * <h3>Attributes</h3>
 * The following attributes can be set on a NHExoPlayerView when used in a layout XML file:
 * <p>
 * <ul>
 ...
 * To customize the layout of NHExoPlayerView throughout your app, or just for certain
 * configurations, you can define {@code exo_simple_player_view.xml} layout files in your
 * application {@code res/layout*} directories. These layouts will override the one provided by the
 * ExoPlayer library, and will be inflated for use by NHExoPlayerView. The view identifies and
 ...
 * NHExoPlayerView throughout your application. It's also possible to customize the layout for a
 * single instance in a layout file. This is achieved by setting the {@code player_layout_id}
 * attribute on a NHExoPlayerView. This will cause the specified layout to be inflated instead
 * of {@code exo_simple_player_view.xml} for only the instance on which the attribute is set.
 */
@TargetApi(16)
public final class NHExoPlayerView extends FrameLayout {
    ...
    public NHExoPlayerView(Context context) {
        this(context, null);
    }

    public NHExoPlayerView(Context context, AttributeSet attrs) {
     ...
     *
     * @param player The {@link NHExoPlayerView} to use.
     */
    ...
    private final class ComponentListener implements SimpleExoPlayer.VideoListener,
        ...
        // NHExoPlayerView.VideoListener implementation
