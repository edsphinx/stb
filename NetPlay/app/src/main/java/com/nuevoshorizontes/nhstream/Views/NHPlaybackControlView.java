package com.nuevoshorizontes.nhstream.Views;
 ...
 */
public class NHPlaybackControlView extends FrameLayout {
    ...
    private final NHRegularTextView movie_name;
    private final NHRegularTextView durationView;
    private final NHRegularTextView positionView;
    ...
    public NHPlaybackControlView(Context context) {
        this(context, null);
    }

    public NHPlaybackControlView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NHPlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        movie_name = (NHRegularTextView) findViewById(R.id.movie_name);
        durationView = (NHRegularTextView) findViewById(R.id.exo_duration);
        positionView = (NHRegularTextView) findViewById(R.id.exo_position);
