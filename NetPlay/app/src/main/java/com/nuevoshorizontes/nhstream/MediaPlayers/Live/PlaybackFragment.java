...
/**
 * Created by FLYNET on 30/10/2017.
 */
...
public class PlaybackFragment extends Fragment {
    ...
    private class SetSelectionRunnable implements Runnable {
        ...
        public void run() {
            ...
            mRowsFragment.setSelectedPosition(mPosition, mSmooth, new ListRowPresenter.SelectItemViewHolderTask(scroll));
        }
    }
    ...
    public void setSelectedPosition(int position) {
        setSelectedPosition(position, true, 5);
    }

    /**
     * Sets the selected row position.
     */
    public void setSelectedPosition(int position, boolean smooth,  int scroll) {
        mSetSelectionRunnable.mPosition = position;
        mSetSelectionRunnable.mSmooth = smooth;
        mSetSelectionRunnable.scroll = scroll;
    ...
    public void notifyPlaybackRowChanged() {
        if (mAdapter == null) {
         ...
         //mAdapter.notifyItemRangeChanged(5, 1);
    }
