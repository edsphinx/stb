...
public class NHBrandedFragment extends Fragment {
    ...
    public View onInflateTitleView(LayoutInflater inflater, ViewGroup parent,
        ...
        boolean found = parent.getContext().getTheme().resolveAttribute(
                android.support.v17.leanback.R.attr.browseTitleViewLayout, typedValue, true);
        return inflater.inflate(found ? typedValue.resourceId : android.support.v17.leanback.R.layout.lb_browse_title,
                parent, false);
    }
    ...
    public void installTitleView(LayoutInflater inflater, ViewGroup parent,
        ...
        if (titleLayoutRoot != null) {
            ...
            setTitleView(titleLayoutRoot.findViewById(android.support.v17.leanback.R.id.browse_title_group));
        } else {
            setTitleView(null);
        }
    }
