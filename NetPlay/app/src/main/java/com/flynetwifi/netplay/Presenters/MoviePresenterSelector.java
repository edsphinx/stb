...
public class MoviePresenterSelector extends PresenterSelector {
    ...
    private ListRowPresenter mShadowDisabledRowPresenter = new ListRowPresenter(FocusHighlight.ZOOM_FACTOR_SMALL);

    public MoviePresenterSelector() {
    ...
    @Override public Presenter getPresenter(Object item) {
        //if (!(item instanceof PeliculasListRow)) return mShadowDisabledRowPresenter;
