...
public abstract class NHMediaPlayerGlue extends NHPlaybackControlGlue implements
    ...
    protected NHMediaPlayerGlue(Context context, NHPlaybackOverlayFragment fragment) {
    ...
    @Override public long getSupportedActions() {
        return NHPlaybackControlGlue.ACTION_PLAY_PAUSE | NHPlaybackControlGlue.ACTION_FAST_FORWARD
                | NHPlaybackControlGlue.ACTION_REWIND;
    }
