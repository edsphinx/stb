...
import com.flynetwifi.netplay.Fragments.NHBaseFragment;
import com.flynetwifi.netplay.Fragments.NHRowsFragment;
 ...
 *
 * <p>
 * A NHDetailsFragment renders the elements of its {@link ObjectAdapter} as a set
 * of rows in a vertical list.The Adapter's {@link PresenterSelector} must maintain subclasses
 * of {@link RowPresenter}.
 * </p>
 *
 * When {@link FullWidthDetailsOverviewRowPresenter} is found in adapter,  NHDetailsFragment will
 ...
 *
 * <p>
 * The recommended activity themes to use with a NHDetailsFragment are
 * <li>
 ...
 * </p>
 */
public class NHDetailsFragment extends NHBaseFragment {
    ...
    private NHRowsFragment mRowsFragment;
    ...
    private final NHDetailsFragment.SetSelectionRunnable mSetSelectionRunnable = new NHDetailsFragment.SetSelectionRunnable();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContainerListAlignTop =
                getResources().getDimensionPixelSize(android.support.v17.leanback.R.dimen.lb_details_rows_align_top);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View view = inflater.inflate(android.support.v17.leanback.R.layout.lb_details_fragment, container, false);
        ViewGroup fragment_root = (ViewGroup) view.findViewById(android.support.v17.leanback.R.id.details_fragment_root);
        installTitleView(inflater, fragment_root, savedInstanceState);
        mRowsFragment = (NHRowsFragment) getChildFragmentManager().findFragmentById(
                android.support.v17.leanback.R.id.details_rows_dock);
        if (mRowsFragment == null) {
            mRowsFragment = new NHRowsFragment();
            getChildFragmentManager().beginTransaction()
                    .replace(android.support.v17.leanback.R.id.details_rows_dock, mRowsFragment).commit();
        }
    ...
    protected void setupDetailsOverviewRowPresenter(FullWidthDetailsOverviewRowPresenter presenter) {
        ...
        alignDef1.setItemAlignmentViewId(android.support.v17.leanback.R.id.details_frame);
        alignDef1.setItemAlignmentOffset(- getResources()
                .getDimensionPixelSize(android.support.v17.leanback.R.dimen.lb_details_v2_align_pos_for_actions));
        ...
        alignDef2.setItemAlignmentViewId(android.support.v17.leanback.R.id.details_frame);
        alignDef2.setItemAlignmentFocusViewId(android.support.v17.leanback.R.id.details_overview_description);
        alignDef2.setItemAlignmentOffset(- getResources()
                .getDimensionPixelSize(android.support.v17.leanback.R.dimen.lb_details_v2_align_pos_for_description));
    ...
    /**
     * Gets embedded RowsFragment showing multiple rows for NHDetailsFragment.  If view of
     * NHDetailsFragment is not created, the method returns null.
     * @return Embedded RowsFragment showing multiple rows for NHDetailsFragment.
     */
    public NHRowsFragment getRowsFragment() {
    ...
    private void setupFocusSearchListener() {
        ...
        if (titleHelper != null) {
            BrowseFrameLayout browseFrameLayout = (BrowseFrameLayout) getView().findViewById(
                    android.support.v17.leanback.R.id.details_fragment_root);
