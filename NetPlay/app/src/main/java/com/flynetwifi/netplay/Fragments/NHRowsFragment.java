...
import com.flynetwifi.netplay.Fragments.NHBaseRowFragment;
 ...
 * </p>
 */
public class NHRowsFragment extends NHBaseRowFragment implements
    ...
    public static class MainFragmentAdapter extends BrowseFragment.MainFragmentAdapter<NHRowsFragment> {

        public MainFragmentAdapter(NHRowsFragment fragment) {
            super(fragment);
    ...
    public static class MainFragmentRowsAdapter
            extends BrowseFragment.MainFragmentRowsAdapter<NHRowsFragment> {

        public MainFragmentRowsAdapter(NHRowsFragment fragment) {
            super(fragment);
        }
