package com.flynetwifi.netplay.media;
...
import com.flynetwifi.netplay.Fragments.NHPlaybackOverlayFragment;

/**
 * A helper class for managing a {@link android.support.v17.leanback.widget.PlaybackControlsRow} and
 * {@link NHPlaybackOverlayFragment} that implements a recommended approach to handling standard
 ...
 * {@link NHPlaybackOverlayFragment} is optional.
 * </p>
 *
 ...
 * {@link NHPlaybackOverlayFragment} the fragment's input event
 ...
 *
 */
public abstract class NHPlaybackControlGlue implements OnActionClickedListener, View.OnKeyListener {
    /**
    ...
    private final NHPlaybackOverlayFragment mFragment;
     ...
     */
    public NHPlaybackControlGlue(Context context, int[] seekSpeeds) {
     ...
     */
    public NHPlaybackControlGlue(Context context,
     ...
     *
     * @param context
     * @param fragment Optional; if using a {@link NHPlaybackOverlayFragment}, pass it in.
     * @param seekSpeeds Array of seek speeds for fast forward and rewind.
     */
    public NHPlaybackControlGlue(Context context,
                               NHPlaybackOverlayFragment fragment,
                               int[] seekSpeeds) {
    ...
    private final NHPlaybackOverlayFragment.InputEventHandler mOnInputEventHandler =
            new NHPlaybackOverlayFragment.InputEventHandler() {
                @Override
    ...
    public PlaybackControlsRowPresenter createControlsRowAndPresenter() {
        ...
        AbstractDetailsDescriptionPresenter detailsPresenter =
                new AbstractDetailsDescriptionPresenter() {
                    ...
                    protected void onBindDescription(AbstractDetailsDescriptionPresenter.ViewHolder
                        ...
                        NHPlaybackControlGlue glue = (NHPlaybackControlGlue) object;
        ...
        return new PlaybackControlsRowPresenter(detailsPresenter) {
            ...
            protected void onBindRowViewHolder(RowPresenter.ViewHolder vh, Object item) {
                ...
                vh.setOnKeyListener(NHPlaybackControlGlue.this);
            }
            @Override
     ...
     */
    public NHPlaybackOverlayFragment getFragment() {
        return mFragment;
    }
