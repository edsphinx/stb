...
public class MusicSingersPresenter extends Presenter {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.music_singer_card, parent, false);
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        final MusicSingersCard cancion = (MusicSingersCard) item;

        ((ViewHolder) viewHolder).nombre.setText(cancion.getmNombre());

        ((ViewHolder) viewHolder).updateCardViewImage(cancion.getmImagen());
